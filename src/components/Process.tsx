          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="text-center">
                <div className="w-20 h-20 glass-card flex items-center justify-center mb-6 mx-auto transition-all duration-500 group-hover:scale-110 group-hover:animate-glow animate-float" style={{ animationDelay: `${index * 0.5}s` }}>
                  <step.icon className="w-8 h-8 text-white transition-all duration-300 group-hover:scale-110" />
                </div>
                
                <h3 className="text-xl font-medium text-white mb-4 transition-all duration-300 group-hover:scale-105">
                  {step.title}
                </h3>
